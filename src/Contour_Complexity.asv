...
bwareaopenThreshold  = 30;   % Minimum object area to retain (for noise removal)
complexityThreshold  = 0.8;  % Classification threshold for contour complexity
...
cleanImage = bwareaopen(invertedImage, bwareaopenThreshold);
...
if isempty(stats)
    ...
    if avgComplexity > complexityThreshold
